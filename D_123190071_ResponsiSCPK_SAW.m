...
% Last Modified by GUIDE v2.5 25-Jun-2021 22:18:41
...
%membaca data pada tabel excel dan ditampilkan pada GUI
handles.output = hObject;
x = xlsread('DATA RUMAH.xlsx','A2:A1011');
y = xlsread('DATA RUMAH.xlsx','C2:H1011');
data = [x y];
...
%menentukan 20 data terbaik dari hasil perhitungan
for i=1:20
hasil(i) = nilai(i);
end
...
%perulangan untuk mencari nama rumah dari 20 data terbaik 
for i=1:20
 for j=1:m
   if(hasil(i) == V(j))
